...
plant_colors <- c(
  ...
  "Eschzcholzia californica" = esccal_col,
  "Grindelia camporum" = gricam_col,
  "Stipa pulchra" = stipul_col,
  "Penstemon centranthifoluis" = pencen_col,
...
# creating a new object from original data frame
drought_exp_clean <- drought_exp |>
  # making column names lower case with underscores
  clean_names() |>
...
drought_exp_scatter <- 
  ...
  geom_point() +
  # relabelling x- and y-axes and title
...
drought_exp_jitter <- 
  ...
  labs(title = "Mean plant mass is greater in well watered\ntreatment in comparison to drought stressed treatment",
       x = "Treatment",
       y = "Total mass (g)") +
...
drought_exp_jitter2 <- 
  ...
  # relabelling axes, adding title
  labs(title = "Species differ in total plant mass",
       x = "Species name",
...
- residuals appear normally distribute
...
The best model includes water treament and species as predictors.

**How much variation in the response (total mass, in grams) does this model explain?**

72.6% of the variation in plant mass is explained by a model with bot of these predictors.
